...
--
-- Host: mysql.vooo.ws    Database: vooo_webservice
-- ------------------------------------------------------
...
CREATE TABLE `oauth_sessions` (
  ...
  KEY `oauth_sessions_created_at_index` (`created_at`,`owner_id`),
  KEY `oauth_sessions_updated_at_index` (`updated_at`,`owner_id`),
  KEY `oauth_sessions_updated_at_index2` (`updated_at`,`owner_id`),
...
) ENGINE=InnoDB AUTO_INCREMENT=41315633 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-28 13:44:24
