...
const (
	...
	SetUpSelectForeignExternal = "SELECT referrer_table, referrer_field, referenced_schema, referenced_table, referenced_field FROM ref_init WHERE referrer_schema in (%s) AND referrer_table in (%s);"
